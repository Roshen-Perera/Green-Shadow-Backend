...
public class RegexProcess {
    ...
    private static final String STAFF_GENDER_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    private static final String STAFF_JOINED_DATE_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    private static final String STAFF_DOB_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    ...
    private static final String STAFF_ADDRESS_5_POSTAL_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    private static final String STAFF_CONTACT_NO_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    private static final String STAFF_EMAIL_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
    private static final String STAFF_ROLE_PATTERN = "^[A-Za-z ]{3,50}$";   // Example: Letters and spaces, 3-50 characters
