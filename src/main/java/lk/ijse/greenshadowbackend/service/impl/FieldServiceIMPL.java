...
import lk.ijse.greenshadowbackend.customStatusCodes.SelectedEntityErrorStatus;
   ...
   private Mapping fieldMapping;
    ...
    public FieldStatus getField(String fieldId) {
        if(fieldDao.existsById(fieldId)){
            ...
            return fieldMapping.toFieldDTO(selectedUser);
        }else {
            return new SelectedEntityErrorStatus(404,"Selected field not found");
        }
    }
